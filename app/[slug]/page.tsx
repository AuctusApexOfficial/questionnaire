...
export default function CustomQuestionnairePage({ params }: { params: { slug: string } }) {
  const slug = params.slug

  // Extract the first name and full name from the slug
  let firstName = slug
  ...
  // Capitalize the full name properly
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            <div className="text-center mb-16">
              ...
              >
                <span className="text-[#333]">Tell Us About Your</span>{" "}
                <span className="text-[#b39656]">Vision {capitalized}</span>
              </h2>
            ...
            >
              <Questionnaire firstName={capitalized} fullName={capitalizedFullName} isNamedUrl={true} />
            </div>
          </div>
        </div>
      </section>
